...
contract KushalTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    constructor() {
        ...
        name = "KushalTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KSCN";                                             // Set the symbol for display purposes (CHANGE THIS)
